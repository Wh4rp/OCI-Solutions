...
#show: doc => project(
  ...
  presentation: [
    ...
    - Fase reginal: se lleva a cabo en varias ciudades de Chile y está abierta a todos los estudiantes. Los mejores de cada región se clasifican para la final nacional.
